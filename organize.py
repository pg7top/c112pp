...
to_dir = "C:/Users/pedro/desktop/novas_imagens"
...
for file_name in list_of_files:
    ...
    if extension in     [ ".txt", ".doc", ".docx", ".pdf"]:
        ...
        path2 = to_dir + '/' + "Doc_Files"                     # Example path2 : D:/My Files/Image_Files      
        path3 = to_dir + '/' + "Doc_Files" + '/' + file_name   # Example path3 : D:/My Files/Image_Files/ImageName1.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
